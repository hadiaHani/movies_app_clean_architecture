...
class TopRatedComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(builder: (contoller) {
      return FadeIn(
        ...
        child: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: contoller.topRatedMovieList.length,
            itemBuilder: (context, index) {
              final movie = contoller.topRatedMovieList[index];
              return Container(
                padding: const EdgeInsets.only(right: 8.0),
                child: InkWell(
                  onTap: () {
                    CacheData().setId(movie.id);
